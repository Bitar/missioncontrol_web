...
const KTCardHeader: FC<Props> = ({ className, text, id, bg, text_color, collapse = false, target_id }) => {
  ...
  return (
    <div id={id} className={clsx(`card-header bg-${bg || "white"}`, className && className)} {...opts}>
