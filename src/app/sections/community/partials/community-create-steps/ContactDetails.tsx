  ...
  return (
    <div className="d-flex flex-column pt-5 w-100">
      ...
      <div className="row mb-6">
        ...
        <div className="col-lg-8 fv-row">
          <InputMask mask="+1 (999) 999-9999" className="form-control mb-3 mb-lg-0" placeholder="Phone Number"
                     name="contact.phone_number" onChange={(e) => {
            setFieldValue("contact.phone_number", e.target.value);
          }} />
          <div className="text-danger mt-2">
