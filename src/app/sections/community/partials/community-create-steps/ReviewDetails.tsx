...
export const ReviewDetails: FC = () => {
  ...
  const plan = useMemo(() => plans?.filter((plan) => plan?.id === communityForm?.plan_id)[0], [communityForm?.plan_id, plans]);
          ...
          <KTCard shadow={false}>
            ...
            <KTCardBody>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
                  <span className="fw-bolder fs-6 text-dark">{communityForm?.contact?.phone_number}</span>
                </div>
              </div>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
                  <span className="fw-bolder fs-6 text-dark">{communityForm?.address?.address_one}</span>
                </div>
              </div>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
                  <span className="fw-bolder fs-6 text-dark">{communityForm?.address?.address_two}</span>
                </div>
              </div>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
                  <span
                    className="fw-bolder fs-6 text-dark">{states?.filter((state) => state?.id === communityForm?.address?.state)[0]?.name}</span>
                </div>
              </div>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
                  <span className="fw-bolder fs-6 text-dark">{communityForm?.address?.postal_code}</span>
                </div>
              </div>
              ...
              <div className="row mb-5">
                ...
                <div className="col-lg-8">
              <span
                className="fw-bolder fs-6 text-dark">{communityForm?.access?.type === 1 ? "Public" : "Private"}</span>
                </div>
              </div>
            </KTCardBody>
          </KTCard>
            ...
            <KTCard shadow={false}>
              ...
              <KTCardBody>
                <div className="plan-card">
                  <div
                    className="h-100 w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-10 px-5">
                      ...
                      {plan?.contact_type === 1 && (
                        <div className="text-center">
                          ...
                          {communityForm?.payment_term === 2 && (
                            <span>
                          <span className="fs-3x fw-bolder text-mc-secondary">{annualPrice.toLocaleString()}</span>
                          <span className="fs-7 fw-bold opacity-50">
