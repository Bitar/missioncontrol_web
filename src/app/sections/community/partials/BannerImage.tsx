    ...
    return (
        <>
            <div className='col-lg-8'>
                <div className={clsx('ratio ratio-21x9 image-input image-input-outline', {'image-input-empty': image === '' || image === 'none'})}
                    ...
                    <label className='btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow'
                        ...
                        <input key={imageInput} type='file' name='banner_image' accept='.png, .jpg, .jpeg' onChange={handleOnChange} />
