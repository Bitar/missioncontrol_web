...
const GeneralDetailsStep = () => {
  ...
  return (
    <Formik validationSchema={communitySchema} initialValues={communityForm} onSubmit={handleSubmit}>
      {() => (
        <Form className="py-20 w-100 w-xl-700px" noValidate id="kt_create_account_form">
          <div className="w-100">
            ...
            <div className="fv-row">
              <div className="row">
                <div className="col-lg-6">
                  ...
                  >
                    <KTSVG
                      path="/media/icons/duotune/com005.svg"
