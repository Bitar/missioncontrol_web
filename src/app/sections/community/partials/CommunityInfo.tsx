                ...
                <div className='d-flex flex-column'>
                  ...
                  <div className='d-flex flex-wrap fw-bold fs-6 mb-4 pe-2'>
                    {community?.contact && (
                        <>
                          <div className='d-flex align-items-center text-gray-400 me-5 mb-2'>
                            <KTSVG path='/media/icons/duotune/com006.svg'
                          ...
                          <a
                            ...
                            <KTSVG path='/media/icons/duotune/com011.svg'
                                   className='svg-icon-4 me-1'/>
                    ...
                    <div className='d-flex align-items-center text-gray-400 mb-2'>
                      ...
                      <span className='me-1'>Payment Status:</span> {getStatus(community?.subscription?.status)}
                    </div>
                  </div>
