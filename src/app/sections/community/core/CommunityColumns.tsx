...
const communitiesColumns: ReadonlyArray<Column<Community>> = [
  ...
  },
  {
    ...
    id: "users_count",
    defaultCanSort: true,
    Cell: ({ ...props }) => <TextCell dObject={props.data[props.row.index].additional_data.players_count} />
  },
  {
  ...
  {
    Header: (props) => <CustomHeader tableProps={props} title="Actions" className="text-end min-w-125px" />,
    id: "actions",
    Cell: ({ ...props }) => (
      <ActionsCell
