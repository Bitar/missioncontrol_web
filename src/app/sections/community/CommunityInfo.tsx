            ...
            <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
              <li className="nav-item">
                <Link
                  className={
                    ...
                    (location.pathname === ("/communities/" + community?.id + "/overview") && "active")
                  }
              ...
              <li className="nav-item">
                <Link
                  className={
                    `nav-link text-active-primary me-6 ` +
                    (location.pathname === ("/communities/" + community?.id + "/activities") && "active")
                  }
              ...
              <li className="nav-item">
                <Link
                  className={
                    `nav-link text-active-primary me-6 ` +
                    (location.pathname === ("/communities/" + community?.id + "/settings") && "active")
                  }
