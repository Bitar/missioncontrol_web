                  ...
                  <div className="d-flex flex-wrap">
                    {activity?.registration_dates && (
                      <div className="border border-gray-300 border-dashed rounded min-w-85px- py-3 px-4 me-6 mb-3">
                        ...
                        <div className="fs-4 fw-bold">
                          <span>
                            {getDateConvertedToLocal(activity?.registration_dates?.start_date, activity?.settings?.timezone?.value).format("DD MMM YY")}
                            <span className="mx-1">
                              <i className="fa fa-arrow-circle-right text-mc-secondary"></i>
                            </span>
                            {getDateConvertedToLocal(activity?.registration_dates?.end_date, activity?.settings?.timezone?.value).format("DD MMM YY")}
                          </span>
                        </div>
                      </div>
                    )}
                    {activity?.matchplay_dates && (
                      <div className="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                        ...
                        <div className="fs-4 fw-bold">
                          <span>
                            {getDateConvertedToLocal(activity?.matchplay_dates?.start_date, activity?.settings?.timezone?.value).format("DD MMM YY")}
                            <span className="mx-1">
                              <i className="fa fa-arrow-circle-right text-mc-secondary"></i>
                            </span>
                            {getDateConvertedToLocal(activity?.matchplay_dates?.end_date, activity?.settings?.timezone?.value).format("DD MMM YY")}
                          </span>
                        </div>
                      </div>
                    )}
