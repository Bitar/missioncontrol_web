...
import { Announcement, announcementSchema, initialAnnouncement } from "../../../models/announcement/Announcements";
...
const ActivityAnnouncement: FC = () => {
  ...
  return (
    <KTCard>
      <KTCardHeader text={"Announcements"} bg="primary" text_color={"white"}
                    collapse={true}
