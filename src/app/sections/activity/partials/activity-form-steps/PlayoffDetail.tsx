                            ...
                            {activityForm?.playoff?.teams ? (
                              <>
                                <Badge bg="warning" text="dark">
                                  {" "}
                                  You need at least{" "}
                                  {Math.ceil(Math.log2(activityForm?.playoff?.teams))} playable days of
                                  playoffs{" "}
                                </Badge>{" "}
                                The playoffs dates highly depends on the number of teams. <br />
                                Make sure the number of teams is enough for the dates to generate
                                enough matches for the whole tournament.
                              </>
                            ) : (
                              <></>
                            )}
