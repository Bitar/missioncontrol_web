...
import { updateGame } from "../../core/requests/ActivitySettingsRequests";
import { activityGameSchema } from "../../core/validation/ActivitySchema";
...
export const GameDetail = () => {
  ...
  const handleSubmit = async () => {
    ...
    await updateGame(activity?.id, data)
      .then((response) => {
