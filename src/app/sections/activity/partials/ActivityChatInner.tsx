...
import { ChannelsProvider, usePrivateChannels } from "../ChatChannelProvider";
...
const NOTIFICATION_EVENT = "App\\Events\\MessageSent"
  ...
  return (
    <div className="card-body" id={"kt_chat_messenger_body"}>
      ...
      <ChannelsProvider authUser={currentUser} authToken={auth.token}>
        <Notifications authUserId={currentUser?.id} />
      </ChannelsProvider>
      }
