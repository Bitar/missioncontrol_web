...
export const activityScheduleSchema = Yup.object().shape({
  schedule: Yup.object().shape({
    registration_dates: Yup.object().shape({
      start_date: Yup.number().moreThan(0, "Registration Start Date is required").required("Registration Start Date is required"),
      end_date: Yup.number().moreThan(0, "Registration End Date is required").required("Registration End Date is required")
    }),
    matchplay_dates: Yup.object().shape({
      start_date: Yup.number().moreThan(0, "GameDay Start Date is required").required("Match Play Start Date is required"),
      end_date: Yup.number().moreThan(0, "GameDay End Date is required").required("Match Play End Date is required")
    }),
