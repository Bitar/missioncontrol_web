...
import { ActivityForm, initialActivityFormByActivity } from "../../../models/activity/ActivityForm";
...
const ActivitySettings = () => {
  ...
  const [activityForm, setActivityForm] = useState<ActivityForm>(initialActivityFormByActivity(activity));
