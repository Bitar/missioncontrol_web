...
import { initScoringSetting, ScoringSettingForm } from "../../../../models/game/scoring/ScoringSettings";
...
export const GameModeScoringSettings: FC<Props> = ({
  ...
  const [scoringSettingForm, setScoringSettingForm] = useState<ScoringSettingForm>(initScoringSetting(gameModeScoringSettings));
        ...
        <div className="row">
          <div className="col-6">
            <Select
              ...
              options={scoringKeys}
              value={scoringKeys?.filter((scoringKey) => scoringKey?.id === scoringSettingForm.scoring_key_id)[0]}
              ...
              onChange={(e) => {
                updateData({
                  scoring_key_id: e?.id
                }, setScoringSettingForm, scoringSettingForm);
              }}
            />
          </div>
          <div className="col-6">
