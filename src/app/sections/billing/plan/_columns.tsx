...
const plansColumns: ReadonlyArray<Column<Plan>> = [
  ...
  {
    Header: (props) =>
        <CustomHeader tableProps={props} title='Price' className='min-w-125px'/>,
    id: 'price',
    Cell: ({...props}) => <TextCell dObject={'$' + props.data[props.row.index].price}/>,
  },
  {
    Header: (props) =>
        <CustomHeader tableProps={props} title='Launch' className='min-w-125px'/>,
    id: 'launch',
  ...
  },
  {
    ...
    id: 'actions',
    Cell: ({...props}) => <ActionsCell id={props.data[props.row.index].id} path={'plans'} queryKey={QUERIES.PLANS_LIST}/>,
  },
]
