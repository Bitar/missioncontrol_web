...
import {ActivityTypeQueryResponse} from '../../../models/activity/ActivityType'
...
export const getActivityTypes = (): Promise<ActivityTypeQueryResponse> => {
  ...
  return axios.get(url).then((response: AxiosResponse<ActivityTypeQueryResponse>) => response.data)
}
