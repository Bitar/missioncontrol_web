                        ...
                        <div className="card">
                            <div className="card-body p-0">
                                <div className="card-px text-center py-10">
                                    ...
                                    <p className="text-gray-400 fs-4 fw-bold mb-10">If you are on Mission Control to
                                        host a community and recreational esports activities, start by creating a
                                        community here!</p>
                                ...
                                {/*<div className='mt-4'>*/}
                                    <div className="text-center px-4">
                                        <img className="mw-100 mh-300px" alt=""
                                             src={toAbsoluteUrl('media/avatars/EmptyStateimg.png')}/>
                                    </div>
                                {/*</div>*/}
                            </div>
                        </div>
