                ...
                <div className={`card-body ps-xl-15 d-flex `}>
                    <div className="m-0">
                        <div className="position-relative fs-2x z-index-2 fw-bolder text-white mb-7">
                            ...
                            <p className='text-white fw-bold fs-5 mt-1 mb-7'>If you are on Mission Control to play in
                                leagues and tournaments, you can only do that by downloading our mobile app!</p>
                        </div>
                        <div className="mb-3">
                            <a href='https://missioncontrol.app.link/z7antLdv1qb' target="_blank" rel="noreferrer"
                               className="btn btn-primary fw-bold me-2">Download App</a>
                        </div>
                    </div>
