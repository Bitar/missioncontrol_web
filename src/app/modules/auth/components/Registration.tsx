...
const registrationSchema = Yup.object().shape({
  first_name: Yup.string().max(50, 'Maximum 50 letters').required('First name is required'),
  email: Yup.string().email('Wrong email format').required('Email is required'),
  last_name: Yup.string().max(50, 'Maximum 50 letters').required('Last name is required'),
  password: Yup.string()
