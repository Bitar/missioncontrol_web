                    ...
                    <div className='col-12 col-sm-12 col-xl' key={index}>
                        <div className='card h-100'>
                            <div className='card-body d-flex justify-content-center text-center flex-column p-8'>
                                <a href={supportData.link}
                                   className='text-gray-800 text-hover-primary d-flex flex-column' rel="noreferrer"
                                   target="_blank">
            ...
            <div className='card mb-10'>
                <div className='card-body d-flex align-items-center py-8 '>
                    ...
                    <div className='ms-6'>
                        ...
                        <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
                            Join us every quarter to hear from and ask questions of Mission Control CEO Austin Smith on
                            the state of the platform, upcoming product focuses, and more!
                        </p>
                        <div className="mt-2">
